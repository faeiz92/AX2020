...
namespace AX2020
{
	partial class frm_rpt_coating_output_underweight
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			this.lbl_header.Text = "PRODUCTION OUTPUT - UNDERWEIGHT";
			...
			// 
			// frm_rpt_coating_output_underweight
			// 
			...
			this.Name = "frm_rpt_coating_output_underweight";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "Production Output - Underweight";
