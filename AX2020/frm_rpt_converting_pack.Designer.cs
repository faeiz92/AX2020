...
namespace AX2020
{
	partial class frm_rpt_converting_pack
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			this.lbl_header.Text = "PRODUCTION OUTPUT - PACKING";
			...
			this.Name = "frm_rpt_converting_pack";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "Production Output - Packing";
