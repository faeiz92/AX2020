...
namespace AX2020
{
	partial class frm_prod_warehouse_stretch_film_received
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			this.lbl_header.Text = "STRETCH FILM STOCK RECEIVE";
			...
			// 
			// frm_prod_warehouse_stretch_film_received
			// 
			...
			this.Name = "frm_prod_warehouse_stretch_film_received";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "Stretch Film Stock Receive";
			this.Load += new System.EventHandler(this.Frm_prod_warehouse_stretch_film_receivedLoad);
