...
namespace AX2020
{
	partial class frm_prod_conv_ax_wl_print_one
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			this.lbl_header.Text = "PRINT AX WL LABEL";
			...
			this.txtbx_po_no.Visible = false;
			// 
			// label1
			// 
			...
			this.Name = "frm_prod_conv_ax_wl_print_one";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "Print AX WL Label";
