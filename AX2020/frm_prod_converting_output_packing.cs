...
namespace AX2020
{
	...
	public partial class frm_prod_converting_output_packing : Form
	{
		...
		public frm_prod_converting_output_packing()
		{
			InitializeComponent();
...
//			if (remark5 == "SLITTING")
//			{
//				MessageBox.Show("Please use SLITTING + PACK");	
//				return;
//			}
//			else
//			{
...
//			}
		...
		void AlreadySlit2()
		{
			...
			try 
			{
				...
				cmd_seach.CommandText = @"SELECT TOP 1 * FROM VIEW_PROD_CONV_JO_SLIT_PACK where PROD_DOCNO = @doc_no";
				...
				if(dr.HasRows)
				{
					while(dr.Read())
					{
						if(dr["TOTALROLLSLIT"] != DBNull.Value)
						{
							slit = Double.Parse(dr["TOTALROLLSLIT"].ToString());
						}
						else
						{
							slit = 0;
						...
						if(dr["TOTALROLLPACK"] != DBNull.Value)
						{
							pack = Double.Parse(dr["TOTALROLLPACK"].ToString());
						}
						else
						{
							pack = 0;
						...
						{
							MessageBox.Show("Slitting output reported already done packing \nMake sure the slitting output already done");
							return;
						}
						else
						{
...
//					txtbx_conversion.Text = dr_search["PROD_CONVERSION"].ToString();
			...
			if (txtbx_prod_code.Text.Substring(0, 7) == "B-GRADE" || txtbx_prod_code.Text.Substring(0, 6) == "BGRADE")
			{
				txtbx_jrlotno.Text = txtbx_prod_code.Text;
				txtbx_jr_lot_no_img.Text = "✓";
	            txtbx_jr_lot_no_img.ForeColor = Color.Green;					
	            txtbx_jr_lot_no.Text = txtbx_prod_code.Text;
			}
...
//			}
			//###########################################################
//			int qtyPack = 0, qtySlit = 0;
//			
//			if(remark5 == "SLITTING")
//			{
//				SqlConnection con_Check_Packing = new SqlConnection(sqlconn);
//				SqlCommand cmd_Check_Packing = new SqlCommand();
//				try
//				{
//					cmd_Check_Packing.CommandText = "select sum(TotalRoll) As TotalPack from VIEW_PROD_CONV_JO_PACKING where PROD_DOCNO = '" + txtbx_ref_no.Text.ToUpper() + "'";
//				    cmd_Check_Packing.Connection = con_Check_Packing;
//				    con_Check_Packing.Open();
//				    System.Data.SqlClient.SqlDataReader rd_Check_Packing = cmd_Check_Packing.ExecuteReader(System.Data.CommandBehavior.CloseConnection);
//				    if (rd_Check_Packing.HasRows)
//				    {
//				    	while (rd_Check_Packing.Read())
//				    	{
//				    		qtyPack  = Convert.ToInt32(rd_Check_Packing["TotalPack"].ToString());
//				    	}
//				    }
//				    else
//				    {
...
//				finally
//				{
//					con_Check_Packing.Close();
//				}
//				con_Check_Packing.Dispose();
//				cmd_Check_Packing.Dispose();
//				con_Check_Packing = null;
//				cmd_Check_Packing = null;
//				
//				//---------------------------------------------------------------------------------------
//				
//				SqlConnection con_Check_Slitting = new SqlConnection(sqlconn);
//				SqlCommand cmd_Check_Slitting = new SqlCommand();
//				try
//				{
//					cmd_Check_Slitting.CommandText = "select TOTALROLLSLIT  from VIEW_PROD_CONV_JO_CHECK where PROD_DOCNO = '" + txtbx_ref_no.Text.ToUpper() + "'";
//				    cmd_Check_Slitting.Connection = con_Check_Slitting;
//				    con_Check_Slitting.Open();
//				    System.Data.SqlClient.SqlDataReader rd_Check_Slitting = cmd_Check_Slitting.ExecuteReader(System.Data.CommandBehavior.CloseConnection);
//				    if (rd_Check_Slitting.HasRows)
//				    {
//				    	while (rd_Check_Slitting.Read())
//				    	{
//				    		qtySlit  = Convert.ToInt32(rd_Check_Slitting["TOTALROLLSLIT"].ToString());
//				    	}
//				    }
//				    else
//				    {
...
//				finally
//				{
//					con_Check_Slitting.Close();
//				}
//				con_Check_Slitting.Dispose();
//				cmd_Check_Slitting.Dispose();
//				con_Check_Slitting = null;
//				cmd_Check_Slitting = null;
//				
//				
//				if(qtyPack > qtySlit)
//				{
//					MessageBox.Show("Error - Must do slitting first then only can do packing");
//					return;
//				}
//			}
