...
namespace AX2020
{
	partial class frm_rpt_papercore_output
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			this.lbl_header.Text = "PAPERCORE OUTPUT";
			...
			this.Name = "frm_rpt_papercore_output";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "Papercore Output";
