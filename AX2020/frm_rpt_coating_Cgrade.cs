...
namespace AX2020
{
	...
	/// </summary>
	public partial class frm_rpt_coating_Cgrade : Form
	{
	 ...
	 bool sqlConnParm(string cmd_update)
		{
			using (SqlConnection conn = new SqlConnection(sqlconn))
			{
				...
				try
				{
					...
					reportViewer1.LocalReport.ReportPath = @"..\..\report\Production_Cgrade2.rdl";
					DataSet ds = new DataSet();
