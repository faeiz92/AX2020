...
namespace AX2020
{
	partial class frm_rpt_converting_rewind_detail
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			this.lbl_header.Text = "PRODUCTION OUTPUT - REWINDING DETAIL";
			...
			this.dtp_date_from.MaxDate = new System.DateTime(2017, 12, 27, 0, 0, 0, 0);
			this.dtp_date_from.MinDate = new System.DateTime(2017, 12, 27, 0, 0, 0, 0);
			...
			this.dtp_date_from.Value = new System.DateTime(2017, 12, 27, 0, 0, 0, 0);
			this.dtp_date_from.ValueChanged += new System.EventHandler(this.Dtp_date_fromValueChanged);
			// 
			// btn_cancel
			// 
			...
			// 
			// frm_rpt_converting_rewind_detail
			// 
			...
			this.Name = "frm_rpt_converting_rewind_detail";
