...
{
	/// <summary>
	/// Description of frm_conv_sales_backorder_due.
	/// </summary>
	public partial class frm_conv_sales_backorder_due : Form
	{
		...
		public frm_conv_sales_backorder_due()
		{
			//
		...
		void datagrid()
		{
			string sql = "select * from  [dbo].[VIEW_AXERP_SO_DETAIL_BACKORDER_DUE] ORDER BY SoETD, SoCustomer, SoItemcode";
