...
namespace AX2020
{
	partial class frm_rpt_converting_rewind_fast
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			this.lbl_header.Text = "PRODUCTION OUTPUT - REWINDING FAST INFO";
			...
			// 
			// frm_rpt_converting_rewind_fast
			// 
			...
			this.Name = "frm_rpt_converting_rewind_fast";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "Production Output - Rewinding Fast Info";
