...
namespace AX2020
{
	partial class frm_rpt_converting_cutting_detail
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			this.lbl_header.Text = "PRODUCTION OUTPUT - CUTTING DETAIL";
			...
			// 
			// frm_rpt_converting_cutting_detail
			// 
			...
			this.Name = "frm_rpt_converting_cutting_detail";
