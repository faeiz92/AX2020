...
namespace AX2020
{
	partial class frm_rpt_stretch_film_output
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			this.lbl_header.Text = "STRETCH FILM OUTPUT";
			...
			this.Name = "frm_rpt_stretch_film_output";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "Stretch Film Output";
