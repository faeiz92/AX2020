...
namespace AX2020
{
	...
	public partial class frm_prod_converting_output_packing_r4 : Form
	{
		...
		double  get_qty1 = 0, qty_realmetre1 = 0, balance1 = 0, consume1 = 0, consume_m1 = 0, balance_m1 = 0;
		double  get_qty2 = 0, qty_realmetre2 = 0, balance2 = 0, consume2 = 0, consume_m2 = 0, balance_m2 = 0;
		double  get_qty3 = 0, qty_realmetre3 = 0, balance3 = 0, consume3 = 0, consume_m3 = 0, balance_m3 = 0;
		double  get_qty4 = 0, qty_realmetre4 = 0, balance4 = 0, consume4 = 0, consume_m4 = 0, balance_m4 = 0;
		double  get_qty5 = 0, qty_realmetre5 = 0, balance5 = 0, consume5 = 0, consume_m5 = 0, balance_m5 = 0;
		
		double sum_consume = 0, sum_jr_m2 = 0;
		
		public frm_prod_converting_output_packing_r4()
		{
			InitializeComponent();
			...
			DropDownList("SELECT * FROM TBL_PROD_CONV_JO_MACHINE_LIST WHERE PART = 'PACKING' and MACHINE_NO like 'TA-%' order by MACHINE_NO", cbx_machine, "MACHINE_NO");	
...
//					{
//						if(LineNoGeneratorSlit())
//						{
//							if(!sqlConnParmB("SP_PROD_CONV_JO_PACKING_ADD_R3_BGRADE", txtbx_jr_lot_no1, 
//						               jr_ref_no1, txtbx_reject_1, txtbx_ctn_1, txtbx_roll_1))
//							{
//								return;
//							}
//						}					
...
//						if(LineNoGeneratorSlit())
//						{					
//							if(!sqlConnParmB("SP_PROD_CONV_JO_PACKING_ADD_R3_BGRADE", txtbx_jr_lot_no2, 
//							                jr_ref_no2, txtbx_reject_2, txtbx_ctn_2, txtbx_roll_2))
//							{
//								return;
//							}
//						}
...
//						if(LineNoGeneratorSlit())
//						{
//							if(!sqlConnParmB("SP_PROD_CONV_JO_PACKING_ADD_R3_BGRADE", txtbx_jr_lot_no3, 
//							                jr_ref_no3, txtbx_reject_3, txtbx_ctn_3, txtbx_roll_3))
//							{
//								return;
//							}
//						}
...
//						if(LineNoGeneratorSlit())
//						{
//							if(!sqlConnParmB("SP_PROD_CONV_JO_PACKING_ADD_R3_BGRADE", txtbx_jr_lot_no4, 
//							               jr_ref_no4, txtbx_reject_4, txtbx_ctn_4, txtbx_roll_4))
//							{
//								return;
//							}
//						}
...
//						{
//						
//							if(!sqlConnParmB("SP_PROD_CONV_JO_PACKING_ADD_R3_BGRADE", txtbx_jr_lot_no5, 
//							                jr_ref_no5, txtbx_reject_5, txtbx_ctn_5, txtbx_roll_5))
//							{
//								return;
//							}
//						}
...
//			{
	...
	//			}
				...
				//MessageBox.Show("save 2 - "+jr_shipmark1);
...
//						if(LineNoGeneratorSlit())
//						{
						if(!sqlConnParmSlit("SP_PROD_CONV_JO_PACKING_ADD_R3", jr_shipmark1, jr_width1, shipmark_ori_length1.ToString(), jr_micron1, txtbx_jr_lot_no1,
						               jr_ref_no1, jr_color1, jr_stockcode1, consume_m1, balance1, txtbx_reject_1, txtbx_ctn_1, txtbx_roll_1, txtbx_waste1, txtbx_bal1))
							{
								return;
							}
//						}					
...
//						if(LineNoGeneratorSlit())
//						{					
						if(!sqlConnParmSlit("SP_PROD_CONV_JO_PACKING_ADD_R3", jr_shipmark2, jr_width2, shipmark_ori_length2.ToString(), jr_micron2, txtbx_jr_lot_no2,
							                jr_ref_no2, jr_color2, jr_stockcode2, consume_m2, balance2, txtbx_reject_2, txtbx_ctn_2, txtbx_roll_2, txtbx_waste2, txtbx_bal2))
							{
								return;
							}
//						}
...
//						if(LineNoGeneratorSlit())
//						{
						if(!sqlConnParmSlit("SP_PROD_CONV_JO_PACKING_ADD_R3", jr_shipmark3, jr_width3, shipmark_ori_length3.ToString(), jr_micron3, txtbx_jr_lot_no3,
							                jr_ref_no3, jr_color3, jr_stockcode3, consume_m3, balance3, txtbx_reject_3, txtbx_ctn_3, txtbx_roll_3, txtbx_waste3, txtbx_bal3))
							{
								return;
							}
//						}
...
//						if(LineNoGeneratorSlit())
//						{
						if(!sqlConnParmSlit("SP_PROD_CONV_JO_PACKING_ADD_R3", jr_shipmark4, jr_width4, shipmark_ori_length4.ToString(), jr_micron4, txtbx_jr_lot_no4,
							               jr_ref_no4, jr_color4, jr_stockcode4, consume_m4, balance4, txtbx_reject_4, txtbx_ctn_4, txtbx_roll_4, txtbx_waste4, txtbx_bal4))
							{
								return;
							}
//						}
...
//						{
						...
						if(!sqlConnParmSlit("SP_PROD_CONV_JO_PACKING_ADD_R3", jr_shipmark5, jr_width5, shipmark_ori_length5.ToString(), jr_micron5, txtbx_jr_lot_no5,
							                jr_ref_no5, jr_color5, jr_stockcode5, consume_m5, balance5, txtbx_reject_5, txtbx_ctn_5, txtbx_roll_5, txtbx_waste5, txtbx_bal5))
							{
								return;
							}
//						}
					...
					if(!sqlConnParm("SP_PROD_CONV_JO_PACKING_ADD_R3_2", jr_shipmark1, jr_width1, shipmark_ori_length1.ToString(), jr_micron1, txtbx_jr_lot_no1,
					                jr_ref_no1, jr_color1, jr_stockcode1, consume_m1, balance1, txtbx_reject_1))
					{
						return;
					}
		...
		void CalcWaste1()
		{
			...
			bal = ((double)Double.Parse(txtbx_bal1.Text)*Double.Parse(jr_width1)/(double)1000);
			txtbx_waste1.Text = ((double) get_qty1 - cons - bal).ToString();
			
			txtbx_waste_p1.Text = ((double) Double.Parse(txtbx_waste1.Text) * (double)100 / get_qty1).ToString();
			
			//MessageBox.Show(cons.ToString() + "   " +  get_qty1.ToString() + "   " +  bal.ToString());
		}
		...
		void CalcWaste2()
		{
			...
			bal = ((double)Double.Parse(txtbx_bal2.Text)*Double.Parse(jr_width2)/(double)1000);
			txtbx_waste2.Text = ((double) get_qty2 - cons - bal).ToString();
			
			txtbx_waste_p2.Text = ((double) Double.Parse(txtbx_waste2.Text) * (double)100 / get_qty2).ToString();
		...
		void CalcWaste3()
		{
			...
			bal = ((double)Double.Parse(txtbx_bal3.Text)*Double.Parse(jr_width3)/(double)1000);
			txtbx_waste3.Text = ((double) get_qty3 - cons - bal).ToString();
			
			txtbx_waste_p3.Text = ((double) Double.Parse(txtbx_waste3.Text) * (double)100 / get_qty3).ToString();
		...
		void CalcWaste4()
		{
			...
			bal = ((double)Double.Parse(txtbx_bal4.Text)*Double.Parse(jr_width4)/(double)1000);
			txtbx_waste4.Text = ((double) get_qty4 - cons - bal).ToString();
			
			txtbx_waste_p4.Text = ((double) Double.Parse(txtbx_waste4.Text) * (double)100 / get_qty4).ToString();
		...
		void CalcWaste5()
		{
			...
			bal = ((double)Double.Parse(txtbx_bal5.Text)*Double.Parse(jr_width5)/(double)1000);
			txtbx_waste5.Text = ((double) get_qty5 - cons - bal).ToString();
			
			txtbx_waste_p5.Text = ((double) Double.Parse(txtbx_waste5.Text) * (double)100 / get_qty5).ToString();
...
//		}
		...
		void ConsumeCalculation1()
		{
			...
			consume_m1 = Math.Round(((double)(Double.Parse(txtbx_ctn_1.Text)*
			           Double.Parse(txtbx_conversion.Text)) + 
			           Double.Parse(txtbx_roll_1.Text) + Double.Parse(txtbx_reject_1.Text)) * 
			           Double.Parse(txtbx_width_cust.Text) / 1000, 2);
			...
			balance_m1 = Math.Round(((get_qty1 - consume1)/shipmark_ori_length1*1000), 2);
		...
		void ConsumeCalculation2()
		{
			...
			consume_m2 = Math.Round(((double)(Double.Parse(txtbx_ctn_2.Text)*
			           Double.Parse(txtbx_conversion.Text)) + 
			           Double.Parse(txtbx_roll_2.Text) + Double.Parse(txtbx_reject_2.Text)) * 
			           Double.Parse(txtbx_width_cust.Text) / 1000, 2);
			...
			balance_m1 = Math.Round(((get_qty2 - consume2)/shipmark_ori_length2*1000), 2);
		...
		void ConsumeCalculation3()
		{
			...
			consume_m3 = Math.Round(((double)(Double.Parse(txtbx_ctn_3.Text)*
			           Double.Parse(txtbx_conversion.Text)) + 
			           Double.Parse(txtbx_roll_3.Text) + Double.Parse(txtbx_reject_3.Text)) * 
			           Double.Parse(txtbx_width_cust.Text) / 1000, 2);
			...
			balance_m3 = Math.Round(((get_qty3 - consume1)/shipmark_ori_length3*1000), 2);
		...
		void ConsumeCalculation4()
		{
			...
			consume_m4 = Math.Round(((double)(Double.Parse(txtbx_ctn_4.Text)*
			           Double.Parse(txtbx_conversion.Text)) + 
			           Double.Parse(txtbx_roll_4.Text) + Double.Parse(txtbx_reject_4.Text)) * 
			           Double.Parse(txtbx_width_cust.Text) / 1000, 2);
			...
			balance_m4 = Math.Round(((get_qty4 - consume1)/shipmark_ori_length4*1000), 2);
		...
		void ConsumeCalculation5()
		{
			...
			consume_m5 = Math.Round(((double)(Double.Parse(txtbx_ctn_5.Text)*
			           Double.Parse(txtbx_conversion.Text)) + 
			           Double.Parse(txtbx_roll_5.Text) + Double.Parse(txtbx_reject_5.Text)) * 
			           Double.Parse(txtbx_width_cust.Text) / 1000, 2);
			...
			balance_m5 = Math.Round(((get_qty5 - consume5)/shipmark_ori_length5*1000), 2);
...
//	        	}
	        	...
	        	rdlViewer1.SourceFile = new Uri(baseUri, @"../report/planning_jo_converting_10_2.rdl");
			...
			try 
			{
				...
				if (rd_Check_Duplicate_JO.HasRows)
				{
					if (rd_Check_Duplicate_JO.Read())
					{
						...
						jr_width1 			= rd_Check_Duplicate_JO["PROD_JRWIDTH"].ToString();
						shipmark_ori_length1 = Convert.ToInt32(rd_Check_Duplicate_JO["PROD_JRLENGTH"]);
						
						jr_width1			= Convert.ToString(rd_Check_Duplicate_JO["PROD_JRWIDTH"]);
						...
						//MessageBox.Show("2 - "+jr_length1.ToString() + " "+jr_consume1.ToString());
					}
				}
				else
				{
		...
		public void CheckJRLotNo1()
		{
			...
			try 
			{
				cmd_SP3.CommandText = @"select * from VIEW_CONVERTING_BARCODE where TrxShipmark like @doc_no + '%'";
			...
			try 
			{
				...
				if (rd_Check_Duplicate_JO.HasRows)
				{
					if (rd_Check_Duplicate_JO.Read())
					{
						...
						jr_width2 			= rd_Check_Duplicate_JO["PROD_JRWIDTH"].ToString();
						shipmark_ori_length2 = Convert.ToInt32(rd_Check_Duplicate_JO["PROD_JRLENGTH"]);
						
						jr_width2			= Convert.ToString(rd_Check_Duplicate_JO["PROD_JRWIDTH"]);
			...
			try 
			{
				...
				if (rd_Check_Duplicate_JO.HasRows)
				{
					if (rd_Check_Duplicate_JO.Read())
					{
						...
						jr_width3 			= rd_Check_Duplicate_JO["PROD_JRWIDTH"].ToString();
						shipmark_ori_length3 = Convert.ToInt32(rd_Check_Duplicate_JO["PROD_JRLENGTH"]);
						
						jr_width3			= Convert.ToString(rd_Check_Duplicate_JO["PROD_JRWIDTH"]);
			...
			try 
			{
				...
				if (rd_Check_Duplicate_JO.HasRows)
				{
					if (rd_Check_Duplicate_JO.Read())
					{
						...
						jr_width4 			= rd_Check_Duplicate_JO["PROD_JRWIDTH"].ToString();
						shipmark_ori_length4 = Convert.ToInt32(rd_Check_Duplicate_JO["PROD_JRLENGTH"]);
						
						jr_width4			= Convert.ToString(rd_Check_Duplicate_JO["PROD_JRWIDTH"]);
			...
			try 
			{
				...
				if (rd_Check_Duplicate_JO.HasRows)
				{
					if (rd_Check_Duplicate_JO.Read())
					{
						...
						jr_width5 			= rd_Check_Duplicate_JO["PROD_JRWIDTH"].ToString();
						shipmark_ori_length5 = Convert.ToInt32(rd_Check_Duplicate_JO["PROD_JRLENGTH"]);
						
						jr_width5			= Convert.ToString(rd_Check_Duplicate_JO["PROD_JRWIDTH"]);
						
						jr_consume5			= Convert.ToDouble(rd_Check_Duplicate_JO["PROD_CONSUME_TOTAL"]); //m2
