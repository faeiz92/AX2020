...
namespace AX2020
{
	...
	/// </summary>
	public partial class frm_prod_ribbon2_print : Form
	{
		...
		//frm_prod_ribbon2 obj_ribbon = new frm_prod_ribbon2();
		...
		public frm_prod_ribbon2_print( )
		{
			
			InitializeComponent();
	
			txtbx_jo_ribbon.Text = frm_prod_ribbon2.SetValueForText1;
			
			
			//else
			//txtbx_jo_ribbon.Text = frm_prod_ribbon2_output.SetValueForText1;
			
			
			
			//else
			//txtbx_jo_ribbon.Text = frm_prod_ribbon2.SetValueForText2;
...
//		cmd_data_add.Parameters["@SP_JO_SCHWANER"].Value = txtbx_jo_ribbon.Text.ToUpper();
	 ...
	 void report1()
	 {
				...
				reportViewer1.LocalReport.ReportPath = (@"..\..\report\ribbon_report.rdl");
...
private DataSet GetDate ()
{
	...
	try
	{
			cmd_SP1.CommandText = cmd_SP1.CommandText = "select * from TBL_PROD_RIBBON where JO_NO =  '" + txtbx_jo_ribbon.Text + "'";
