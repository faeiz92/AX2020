...
namespace AX2020
{
	partial class frm_menu_sales
	{
		...
		private void InitializeComponent()
		{
			...
			this.btn_converting.Text = "Upload";
			...
			this.btn_get_so.Location = new System.Drawing.Point(380, 120);
			this.btn_get_so.Margin = new System.Windows.Forms.Padding(1);
			this.btn_get_so.Name = "btn_get_so";
			this.btn_get_so.Size = new System.Drawing.Size(231, 61);
			this.btn_get_so.TabIndex = 1;
			this.btn_get_so.Text = "Get Sales Order";
			this.btn_get_so.UseVisualStyleBackColor = false;
			this.btn_get_so.Click += new System.EventHandler(this.Btn_coatingClick);
			// 
			// frm_menu_sales
			// 
			...
			this.Controls.Add(this.btn_get_so);
