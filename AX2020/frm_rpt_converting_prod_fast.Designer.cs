...
namespace AX2020
{
	partial class frm_rpt_converting_prod_fast
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			this.lbl_header.Text = "PRODUCTION OUTPUT - SLITTING FAST INFO";
			...
			this.Name = "frm_rpt_converting_prod_fast";
