...
namespace AX2020
{
	partial class frm_ax_stock_status_sm04
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			this.lbl_header.TabIndex = 189;
			this.lbl_header.Text = "SM04 STOCK RETURN";
			...
			this.Name = "frm_ax_stock_status_sm04";
			this.Text = "frm_ax_stock_status_sm04";
