...
namespace AX2020
{
	partial class frm_prod_warehouse_ax_print
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			this.lbl_header.Text = "AX WJ303 PRINT LABEL";
			...
			this.btn_converting.Text = "Print One ";
			...
			this.Name = "frm_prod_warehouse_ax_print";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "AX WJ3030 Print Label";
