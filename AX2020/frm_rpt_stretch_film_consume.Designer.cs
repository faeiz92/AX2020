...
namespace AX2020
{
	partial class frm_rpt_stretch_film_consume
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			this.lbl_header.Text = "STRETCH FILM CONSUME";
			...
			this.Name = "frm_rpt_stretch_film_consume";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "Stretch Film Consume";
