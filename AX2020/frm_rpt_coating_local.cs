...
namespace AX2020
{
	...
	/// </summary>
	public partial class frm_rpt_coating_local : Form
	{
	 ...
	 bool sqlConnParm(string cmd_update)
		{
			using (SqlConnection conn = new SqlConnection(sqlconn))
			{
				...
				try
				{
					...
					reportViewer1.LocalReport.ReportPath = @"..\..\report\Production_Local.rdl";
					DataSet ds = new DataSet();

					
					ds = GetData(@"SELECT * FROM VIEW_AX2020_PRODUCTION_WIP");
