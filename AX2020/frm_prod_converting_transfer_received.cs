...
namespace AX2020
{
	...
	public partial class frm_prod_converting_transfer_received : Form
	{
		...
		public frm_prod_converting_transfer_received()
		{
		...
		void Btn_addClick(object sender, EventArgs e)
		{
			...
			try 
			{
				cmd_search.CommandText = "select * from TBL_PROD_WAREHOUSE_AX_TRANSFER_ORDER" +
					" where PROD_LINE = @ship_mark and PROD_TOWAREHOUSE = 'GFWPM04'";
...
//		    }
		...
		void DataGrid()
		{
			...
			try 
			{
				...
				cmd_SP.CommandText = @"SELECT PROD_CODE, PROD_LOTNO, PROD_Brand, PROD_SHIPMARK, PROD_BARCODE, PROD_Color, prod_micron, PROD_Width, PROD_Length, prod_fromwarehouse FROM TBL_PROD_WAREHOUSE_AX_TRANSFER_ORDER" +
					" where PROD_LINE = @ship_mark and PROD_TOWAREHOUSE = 'GFWPM04'";
				cmd_SP.Parameters.AddWithValue("@ship_mark",  txtbx_no.Text.ToUpper());
			    ...
			    dataadapter.Fill(ds);
  				...
  				this.dt_grid_add.DataSource = AutoNumberedTable(ds);
			...
			finally
			{
	            ...
	            dt_grid_add.Columns[1].Name = "Stock Code";
	            dt_grid_add.Columns[1].Width = 50;
	            dt_grid_add.Columns[1].ReadOnly = true;
	            dt_grid_add.Columns[2].Name = "LotNo";
				dt_grid_add.Columns[2].Width = 80;            
				dt_grid_add.Columns[2].ReadOnly = true;
				dt_grid_add.Columns[3].Name = "Customer";
				dt_grid_add.Columns[3].Width = 100;
				dt_grid_add.Columns[3].ReadOnly = true;
	            dt_grid_add.Columns[4].Name = "Shipping Mark";
				dt_grid_add.Columns[4].Width = 80;
				dt_grid_add.Columns[4].ReadOnly = true;
				dt_grid_add.Columns[5].Name = "Barcode";
				dt_grid_add.Columns[5].Width = 70;
				dt_grid_add.Columns[5].ReadOnly = true;
				dt_grid_add.Columns[6].Name = "Color";
				dt_grid_add.Columns[6].Width = 50;
				dt_grid_add.Columns[6].ReadOnly = true;
				dt_grid_add.Columns[7].Name = "Micron";
				dt_grid_add.Columns[7].Width = 50;
				dt_grid_add.Columns[7].ReadOnly = true;
				dt_grid_add.Columns[8].Name = "Width";
				dt_grid_add.Columns[8].Width = 50;
				dt_grid_add.Columns[8].ReadOnly = true;
				dt_grid_add.Columns[9].Name = "Length";
				dt_grid_add.Columns[9].Width = 50;
				dt_grid_add.Columns[9].ReadOnly = true;
				dt_grid_add.Columns[10].Name = "Warehouse";
				dt_grid_add.Columns[10].Width = 50;
				dt_grid_add.Columns[10].ReadOnly = true;
...
//                	((ComboBox)c).Items.Clear(); 
		...
		void Btn_saveClick(object sender, EventArgs e)
		{
			...
			{
				if(!sqlConnParm("SP_PROD_CONV_AX_TRANSFER_RECEIVE_ADD", i))
				return;
			}
		...
		public bool sqlConnParm(string sqlStatement, int i)
		{
			...
			try
			{
				...
				cmd_data.Parameters["@SP_PROD_LINE"].Value = txtbx_no.Text.ToUpper() + ".PM04";
				...
				cmd_data.Parameters["@SP_PROD_REMARK1"].Value = "CONVERTING";
