...
namespace AX2020
{
	...
	/// </summary>
	public partial class frm_rpt_coating_output_detail : Form
	{
		...
		public frm_rpt_coating_output_detail()
		{
			//ort.
			//
			InitializeComponent();
	 ...
	 bool sqlConnParm(string cmd_update)
		{
			using (SqlConnection conn = new SqlConnection(sqlconn))
			{
				...
				try
				{
					...
					reportViewer1.LocalReport.ReportPath = @"..\..\report\Production_Output_detail.rdl";
					DataSet ds = new DataSet();
...
//					DataSet ds5 = new DataSet();
					...
					ds = GetData(@"SELECT * FROM VIEW_AX2020_PRODUCTION_OUTPUT_DETAIL");
...
//						reportViewer1.LocalReport.DataSources.Add(rds5);			
		...
		void Btn_generateClick(object sender, EventArgs e)
		{
			...
			if(!sqlConnParm("SP_AX2020_PRODUCTION_OUTPUT_DETAIL2"))
				return;
