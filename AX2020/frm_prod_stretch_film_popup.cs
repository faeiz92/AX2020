...
{
	/// <summary>
	/// Description of frm_prod_stretch_film_popup
	/// </summary>
	public partial class frm_prod_stretch_film_popup : Form
	{
		...
		public frm_prod_stretch_film_popup()
		{
			InitializeComponent();
...
//	            dt_grid.Columns[3].HeaderText = "UOM"; 	
		...
		void Frm_prod_ribbon_popupLoad(object sender, EventArgs e)
		{
			DataGrid();
		}
