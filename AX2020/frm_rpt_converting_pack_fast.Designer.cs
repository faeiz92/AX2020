...
namespace AX2020
{
	partial class frm_rpt_converting_pack_fast
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			this.lbl_header.Text = "PRODUCTION OUTPUT - PACKING FAST INFO";
			...
			this.Name = "frm_rpt_converting_pack_fast";
