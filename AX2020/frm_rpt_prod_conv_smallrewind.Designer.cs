...
namespace AX2020
{
	partial class frm_rpt_prod_conv_smallrewind
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			this.lbl_header.Text = "REPORT SMALL REWINDING";
			...
			this.Name = "frm_rpt_prod_conv_smallrewind";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "Report Small Rewinding";
