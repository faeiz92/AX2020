...
namespace AX2020
{
	partial class frm_rpt_converting_cutting_shift_fast
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			this.lbl_header.Text = "PRODUCTION OUTPUT - CUTTING SHIFT FAST INFO";
			...
			// 
			// frm_rpt_converting_cutting_shift_fast
			// 
			...
			this.Name = "frm_rpt_converting_cutting_shift_fast";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "Production Output - Slitting Fast Info";
