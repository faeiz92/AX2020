...
namespace AX2020
{
	...
	public partial class frm_prod_converting_store_r2 : Form
	{
		...
		public frm_prod_converting_store_r2()
		{
			InitializeComponent();
...
//			cmd_SP1 = null;	
			...
			string ERP_ST_P1_objSqlStatement = "select mcode, mdesc1, mdesc2, mbrand, muom_p, muom_s, mfraction, mremark1, mpack_length, mpack_width, mpack_height from stk where mmc = 'GF' and mcode like '8%' and mstatus = 'A' and mcode not like '%OEM' and mcode not like '%m2'  and mcode = '" + txtbx_stock_code.Text.ToUpper() + "'";
...
//		
		...
		try
		{
			...
			SqlDataAdapter thisAdapter = new SqlDataAdapter("Select JODOCNO, JOLINENO, JOSTOCKCODE, JOSTOCKDESC1, JOSTOCKDESC2, JOSTOCKQTYORDER from TBL_PROD_CONV_STORE_POST where JODOCNO = '" + txtbx_ref_no.Text + "' order by JOLINENO", sqlconn);
			DataSet DataSet = new DataSet(); 
			
			thisAdapter.Fill(DataSet, "TBL_PROD_CONV_STORE_POST");
