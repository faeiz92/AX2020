...
namespace AX2020
{
	partial class frm_prod_warehouse_transfer_received
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			this.txtbx_no = new System.Windows.Forms.TextBox();
			...
			this.lbl_header.Text = "AX STOCK RECEIVE - JR";
			...
			// grpBx_search
			// 
			this.grpBx_search.Controls.Add(this.label2);
			this.grpBx_search.Controls.Add(this.btn_add);
			this.grpBx_search.Controls.Add(this.cbx_warehouse_to);
			this.grpBx_search.Controls.Add(this.label1);
			this.grpBx_search.Controls.Add(this.txtbx_no);
			...
			this.grpBx_search.Visible = false;
			// 
			// label2
			// 
			...
			this.cbx_warehouse_to.Location = new System.Drawing.Point(618, 22);
			...
			// txtbx_no
			// 
			this.txtbx_no.Font = new System.Drawing.Font("Arial", 12F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
			this.txtbx_no.Location = new System.Drawing.Point(133, 21);
			this.txtbx_no.Name = "txtbx_no";
			this.txtbx_no.Size = new System.Drawing.Size(274, 26);
			this.txtbx_no.TabIndex = 1;
			// 
			// groupbx_add
			// 
			...
			this.groupbx_add.Location = new System.Drawing.Point(23, 162);
			...
			// 
			// frm_prod_warehouse_transfer_received
			// 
			...
			this.Name = "frm_prod_warehouse_transfer_received";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "AX Stock Receive - JR";
		...
		private System.Windows.Forms.TextBox txtbx_no;
