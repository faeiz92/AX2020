...
namespace AX2020
{
	partial class frm_prod_warehouse_transfer_jr
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			this.lbl_header.Text = "AX JR TRANSFER";
			...
			// 
			// frm_prod_warehouse_transfer_jr
			// 
			...
			this.Name = "frm_prod_warehouse_transfer_jr";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "AX JR Transfer";
