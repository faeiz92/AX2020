...
namespace AX2020
{
	...
	public partial class frm_rpt_converting_rewind : Form
	{
		...
		public frm_rpt_converting_rewind()
		{
		...
		private DataSet GetData(DateTime date_fr, DateTime date_to)
		{
			...
			{
				MessageBox.Show("Error - Converting Rewind \nCannot load DB \n" + ex.Message + ex.ToString());
				return null;
			}
			finally
			{
			...
			try
				{
					...
					reportViewer1.LocalReport.ReportPath = @"..\..\report\PROD_CONV_REWIND_OUTPUT.rdl";
					DataSet ds = new DataSet();
