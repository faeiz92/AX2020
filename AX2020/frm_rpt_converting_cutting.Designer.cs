...
namespace AX2020
{
	partial class frm_rpt_converting_cutting
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			this.lbl_header.Text = "PRODUCTION OUTPUT - CUTTING";
			...
			this.Name = "frm_rpt_converting_cutting";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "Production Output - Slitting";
