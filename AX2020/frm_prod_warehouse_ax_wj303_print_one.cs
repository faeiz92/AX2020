...
namespace AX2020
{
	...
	public partial class frm_prod_warehouse_ax_wj303_print_one : Form
	{
		public static string sqlconn = "Server=AX-UAT; Password=sbax2020sbg; User ID=sbax2020; Initial Catalog=SBG_AX_2020; Integrated Security=false";
		string jr_shipmark, jr_barcode;
		
		public frm_prod_warehouse_ax_wj303_print_one()
		{
			InitializeComponent();
		...
		private DataSet GetData()
		{
			...
			SqlCommand cmd = new SqlCommand(@"SELECT * FROM TBL_PROD_WAREHOUSE_AX_WJ303_TEMP order by prod_stockcode, prod_shipmark", conn);
		...
		void TempTable()
		{
			using (SqlConnection conn = new SqlConnection(sqlconn))
			{
				...
				SqlCommand cmd  = new SqlCommand("SP_PROD_WAREHOUSE_AX_WJ303_TEMP", conn);
