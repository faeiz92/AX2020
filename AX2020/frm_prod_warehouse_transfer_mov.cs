...
{
	/// <summary>
	/// Description of frm_prod_warehouse_transfer_mov.
	/// </summary>
	public partial class frm_prod_warehouse_transfer_mov : Form
	{
		...
		public frm_prod_warehouse_transfer_mov()
		{
			InitializeComponent();
			...
			DropDownList("SELECT WAREHOUSEID FROM TBL_PROD_WAREHOUSE_AX_WAREHOUSE WHERE FLAG1 = 'FROM' and flag2 = 'MOV' ORDER BY WAREHOUSEID", cbx_warehouse_from, "WAREHOUSEID");
			DropDownList("SELECT WAREHOUSEID FROM TBL_PROD_WAREHOUSE_AX_WAREHOUSE WHERE FLAG1 = 'TO' and flag2 = 'MOV' ORDER BY WAREHOUSEID", cbx_warehouse_to, "WAREHOUSEID");
