...
namespace AX2020
{
	...
	/// </summary>
	public partial class frm_prod_coating_printing_bom : Form
	{
		
		string username;
		public static string sqlconn = "Server=AX-UAT; Password=sbax2020sbg; User ID=sbax2020; Initial Catalog=SBG_AX_2020; Integrated Security=false";
		public frm_prod_coating_printing_bom()
		{
			//
...
//						}
					...
					SqlDataReader rd_Check_Duplicate_word = cmd_Check_Duplicate_word.ExecuteReader(System.Data.CommandBehavior.CloseConnection);
						...
						cmd_data_add.CommandText = "SP_PROD_COAT_PRINTING_BOM_ADD";	//nama store procedure
		...
		void Btn_deleteClick(object sender, EventArgs e)
		{
				...
				try {
						...
						cmd_data_del.CommandText = "SP_PROD_COAT_PRINTING_BOM_DEL";	//nama store procedure
						...
						cmd_data_del.Parameters["@SP_JOPPREFNO"].Value = Convert.ToInt32(txtbx_refNo.Text);
