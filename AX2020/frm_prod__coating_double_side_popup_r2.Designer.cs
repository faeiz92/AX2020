...
namespace AX2020
{
	partial class frm_prod_double_side_popup
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			this.txtbx_stockcode.TextChanged += new System.EventHandler(this.Txtbx_stockcodeTextChanged);
			// 
			// label1
			// 
			...
			this.Name = "frm_prod_double_side_popup";
