...
namespace AX2020
{
	...
	public partial class frm_prod_converting_output_scan : Form
	{
		...
		public frm_prod_converting_output_scan()
		{
...
//				dt.Columns[0].HeaderText = "Jo No";
//				dt.Columns[0].Width = 80;
//				dt.Columns[1].HeaderText = "Customer";
...
//				dt.Columns[11].HeaderText = "Qty Roll";
		...
		void Search()
		{
			...
			//DataGrid("SELECT [PROD_JONO], [JOCUSTOMER], ,[JOSTOCKWIDTH], [JOSTOCKLENGTH], [JOSTOCKMICRON], [JOPRODREMARK0c],[PROD_JRSHIPMARK] ,[PROD_LOTNO]
      
      
      
      
      DataGrid("SELECT * FROM VIEW_PROD_CONV_JO_SLITTING_JR_BALANCE where [PROD_JRSHIPMARK] like '" + txtbx_shihp_mark.Text.ToUpper() + "%'", dt_grid);
...
//				}
		...
		void Txtbx_pack_noKeyUp(object sender, KeyEventArgs e)
		{
			...
			ds.DefaultView.RowFilter = "PROD_LINE LIKE '%" + txtbx_shihp_mark.Text + "%'";
   			this.dt_grid.DataSource = ds.DefaultView;
		}
		
		void Txtbx_shihp_markKeyDown(object sender, KeyEventArgs e)
		{
