...
namespace AX2020
{
	partial class frm_prod_warehouse_transfer_received_fr
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			this.lbl_header.Text = "AX STOCK RECEIVE - FR";
			...
			this.btn_add.Location = new System.Drawing.Point(412, 21);
			...
			this.groupbx_add.Location = new System.Drawing.Point(20, 162);
			...
			// 
			// frm_prod_warehouse_transfer_received_fr
			// 
			...
			this.Name = "frm_prod_warehouse_transfer_received_fr";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "AX Stock Receive - FR";
