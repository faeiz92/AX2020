...
namespace AX2020
{
	partial class frm_rpt_procurement_po_pending_del
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			this.lbl_header.Text = "PURCHASE ORDER - PENDING DELIVERY";
			...
			// 
			// frm_rpt_procurement_po_pending_del
			// 
			...
			this.Name = "frm_rpt_procurement_po_pending_del";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "Purchase Order - Pending Delivery";
