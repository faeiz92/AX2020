...
namespace AX2020
{
	...
	public partial class frm_prod_warehouse_transfer_bopp : Form
	{
		...
		public frm_prod_warehouse_transfer_bopp()
		{
			...
			DropDownList("SELECT WAREHOUSEID FROM TBL_PROD_WAREHOUSE_AX_WAREHOUSE WHERE FLAG1 = 'FROM' and flag2 = 'BOPP' ORDER BY WAREHOUSEID", cbx_warehouse_from, "WAREHOUSEID");
			DropDownList("SELECT WAREHOUSEID FROM TBL_PROD_WAREHOUSE_AX_WAREHOUSE WHERE FLAG1 = 'TO' and flag2 = 'BOPP' ORDER BY WAREHOUSEID", cbx_warehouse_to, "WAREHOUSEID");
