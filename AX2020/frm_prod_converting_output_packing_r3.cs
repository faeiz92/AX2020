...
namespace AX2020
{
	...
	public partial class frm_prod_converting_output_packing_r3 : Form
	{
		...
		public frm_prod_converting_output_packing_r3()
		{
	...
	//			}
				...
				if (LineNoGenerator())
				{
					if(!String.IsNullOrEmpty(txtbx_jr_lot_no1.Text))
					{
						if(LineNoGeneratorSlit())
						{
							if(!sqlConnParmSlit("SP_PROD_CONV_JO_PACKING_ADD_R3", jr_shipmark1, jr_width1, jr_length1, jr_micron1, txtbx_jr_lot_no1, 
						               jr_ref_no1, jr_color1, jr_stockcode1, consume1, balance1, txtbx_reject_1, txtbx_ctn_1, txtbx_roll_1))
							{
								return;
							}
						}					
					...
					if(!String.IsNullOrEmpty(txtbx_jr_lot_no2.Text))
					{
						if(LineNoGeneratorSlit())
						{					
							if(!sqlConnParmSlit("SP_PROD_CONV_JO_PACKING_ADD_R3", jr_shipmark2, jr_width2, jr_length2, jr_micron2, txtbx_jr_lot_no2, 
							                jr_ref_no2, jr_color2, jr_stockcode2, consume2, balance2, txtbx_reject_2, txtbx_ctn_2, txtbx_roll_2))
							{
								return;
							}
						}
					...
					if(!String.IsNullOrEmpty(txtbx_jr_lot_no3.Text))
					{
						if(LineNoGeneratorSlit())
						{
							if(!sqlConnParmSlit("SP_PROD_CONV_JO_PACKING_ADD_R3", jr_shipmark3, jr_width3, jr_length3, jr_micron3, txtbx_jr_lot_no3, 
							                jr_ref_no3, jr_color3, jr_stockcode3, consume3, balance3, txtbx_reject_3, txtbx_ctn_3, txtbx_roll_3))
							{
								return;
							}
						}
					...
					if(!String.IsNullOrEmpty(txtbx_jr_lot_no4.Text))
					{
						if(LineNoGeneratorSlit())
						{
							if(!sqlConnParmSlit("SP_PROD_CONV_JO_PACKING_ADD_R3", jr_shipmark4, jr_width4, jr_length4, jr_micron4, txtbx_jr_lot_no4, 
							               jr_ref_no4, jr_color4, jr_stockcode4, consume4, balance4, txtbx_reject_4, txtbx_ctn_4, txtbx_roll_4))
							{
								return;
							}
						}
					...
					if(!String.IsNullOrEmpty(txtbx_jr_lot_no5.Text))
					{
						if(LineNoGeneratorSlit())
						{
							...
							if(!sqlConnParmSlit("SP_PROD_CONV_JO_PACKING_ADD_R3", jr_shipmark5, jr_width5, jr_length5, jr_micron5, txtbx_jr_lot_no5, 
							                jr_ref_no5, jr_color5, jr_stockcode5, consume5, balance5, txtbx_reject_5, txtbx_ctn_5, txtbx_roll_5))
							{
								return;
							}
						}
...
//		}
		...
		{
			consume1 = Math.Round(Double.Parse(txtbx_length_cust.Text) * ((double)(Double.Parse(txtbx_ctn_1.Text)*Double.Parse(txtbx_conversion.Text)) + Double.Parse(txtbx_roll_1.Text)) * Double.Parse(txtbx_width_cust.Text) / 1000, 2);
			balance1 = Math.Round(get_qty1 - consume1, 2);
		}
		
		void ConsumeCalculation2()
		{
			consume2 = Math.Round(Double.Parse(txtbx_length_cust.Text) * ((double)(Double.Parse(txtbx_ctn_2.Text)*Double.Parse(txtbx_conversion.Text)) + Double.Parse(txtbx_roll_2.Text)) * Double.Parse(txtbx_width_cust.Text) / 1000, 2);
			balance2 = Math.Round(get_qty2 - consume2, 2);
		}
		
		void ConsumeCalculation3()
		{
			consume3 = Math.Round(Double.Parse(txtbx_length_cust.Text) * ((double)(Double.Parse(txtbx_ctn_3.Text)*Double.Parse(txtbx_conversion.Text)) + Double.Parse(txtbx_roll_3.Text)) * Double.Parse(txtbx_width_cust.Text) / 1000, 2);
			balance3 = Math.Round(get_qty3 - consume3, 2);
		}
		
		void ConsumeCalculation4()
		{
			consume4 = Math.Round(Double.Parse(txtbx_length_cust.Text) * ((double)(Double.Parse(txtbx_ctn_4.Text)*Double.Parse(txtbx_conversion.Text)) + Double.Parse(txtbx_roll_4.Text)) * Double.Parse(txtbx_width_cust.Text) / 1000, 2);
			balance4 = Math.Round(get_qty4 - consume4, 2);
		}
		
		void ConsumeCalculation5()
		{
			consume5 = Math.Round(Double.Parse(txtbx_length_cust.Text) * ((double)(Double.Parse(txtbx_ctn_5.Text)*Double.Parse(txtbx_conversion.Text)) + Double.Parse(txtbx_roll_5.Text)) * Double.Parse(txtbx_width_cust.Text) / 1000, 2);
