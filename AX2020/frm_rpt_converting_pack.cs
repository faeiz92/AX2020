...
namespace AX2020
{
	...
	public partial class frm_rpt_converting_pack: Form
	{
		...
		public frm_rpt_converting_pack()
		{
			InitializeComponent();
		...
		private DataSet GetData(DateTime date_fr, DateTime date_to)
		{
			...
			SqlCommand cmd = new SqlCommand(@"	SELECT	a.JODOCNO,
										...
										FROM 	TBL_PROD_CONV_JO a
												...
												INNER JOIN TBL_PROD_CONV_JO_PACKING b 
			...
			try
				{
					...
					reportViewer1.LocalReport.ReportPath = @"..\..\report\PROD_CONV_PACK_OUTPUT.rdl";
					DataSet ds = new DataSet();
