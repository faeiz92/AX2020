...
namespace AX2020
{
	...
	public partial class frm_prod_converting_output_rewinding_r3 : Form
	{
		string init = "0";
		...
		public frm_prod_converting_output_rewinding_r3()
		{
		...
		void Frm_prod_converting_output_rewinding_r3Load(object sender, EventArgs e)
		{
			ClearAllText(this);
			DataGrid();	
