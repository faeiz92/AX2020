...
{
	/// <summary>
	/// Description of frm_prod_converting_output_rewinding_open_r1.
	/// </summary>
	public partial class frm_prod_converting_output_rewinding_open_r1 : Form
	{
		string init = "0";
		...
		public frm_prod_converting_output_rewinding_open_r1()
		{
			InitializeComponent();
...
//			EnableControls(btn_report);
		...
		void Frm_prod_converting_output_rewindingLoad(object sender, EventArgs e)
		{
			...
			txtbx_ref_no.Text = "RCP-OPEN";
			txtbx_ref_no.ReadOnly = true;			
		...
		void Btn_checkClick(object sender, EventArgs e)
		{
			...
			try 
			{
				...
				cmd.CommandText = "select top 1 a.*, b.DOT_DESCRIPTION from VIEW_AXERP_PDSBATCHATTRIBUTES_FULLINFO a inner join VIEW_AXERP_ITEM_MASTER b " +
					...
					"where a.INVENTBATCHID = @ship_mark or a.grade = @ship_mark";
