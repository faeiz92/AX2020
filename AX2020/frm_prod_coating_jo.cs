...
namespace AX2020
{
	...
	public partial class frm_prod_coating_jo : Form
	{
		...
		string letter6, letter7, letter8, letter9, letter10;
		int NextNo2;
		...
		public frm_prod_coating_jo()	//function y terdapat dalam form
		{
			//
...
//		}
		...
		//	string replacement = Regex.Replace(txtbx_sodesc1.Text, @"\t|\n|\r", "");		

			//txtbx_sodesc1.Text = replacement;
			...
			if (TxtBx_StockCode1.Text.ToUpper().Substring(0,4) =="WJ-P" || TxtBx_StockCode1.Text.ToUpper().Substring(0,3) == "WP1" || TxtBx_StockCode1.Text.ToUpper().Substring(0,3) == "WP2")
			{
				...
				try 
				{
					...
					if (rd_Check_Jodoc_Printing.Read())
					{
							...
							{
								MessageBox.Show("DATA SAVED, JOB ORDER NUMBERS PRINTING EXIST");//Lbl_Message.Text = "Error 1.0 : Duplicate JO! ";
											//return;
							}					
...
//				txt_description = txt_description.Replace(System.Environment.NewLine," ");
//				txt_description = txtbx_sodesc1.Text;
				...
				cmd_data_add.Parameters["@SP_JOUSERDATETIME"].Value = DateTime.Now; //"2016-11-28";//dateTimePicker1.Value.Date;
...
//************************************************************************************************************************
						...
						//************************************************************************************************************************
						//SDate = "JB" & NextNo
						if (combobx_category.Text.ToUpper() == "MZPK" || txtbx_brand.Text.ToUpper() =="MZPK" )
						{
...
//===========================================================================================================================================================
					...
					try 
					{
						...
						if (ERP_P1_objDR.HasRows)
						{
							...
							{
						//====================================================================================================================================================================================================================================================================================
								SOCustomerCode = ERP_P1_objDR["ITEMID"].ToString().ToUpper();
								//MessageBox.Show("try"+SOCustomerCode);
								SOStockCode = ERP_P1_objDR["ITEMID"].ToString().ToUpper();
								TxtBx_StockCode1.Text = ERP_P1_objDR["ITEMID"].ToString().ToUpper();
				
								txtbx_joso.Text = ERP_P1_objDR["SALESID"].ToString().ToUpper();
								txtbx_socustomer.Text = ERP_P1_objDR["DELIVERYNAME"].ToString().ToUpper();
								string socust2 = ERP_P1_objDR["DELIVERYNAME"].ToString().ToUpper();
								//txtbx_socustomer2.Text = socust2.Substring(0, 30);
								//txtbx_remark1.Text = ERP_P1_objDR["DELIVERYNAME"].ToString().ToUpper();
								...
								txtbx_micmax.Text = ERP_P1_objDR["DOT_PRODATTRIBMICRON"].ToString().ToUpper();
								txtbx_jrwidth.Text = ERP_P1_objDR["DOT_PRODATTRIBWIDTH"].ToString().ToUpper();
								//MessageBox.Show(ERP_P1_objDR["tdouble01"].ToString().ToUpper());
								txtbx_jrlength.Text = ERP_P1_objDR["DOT_PRODATTRIBLENGTH"].ToString().ToUpper();
								//MessageBox.Show (txtbx_jrlenght.Text);
								//txtbx_brand.Text = ERP_P1_objDR["DOT_PRODATTRIBBRAND"].ToString();
//---------------------------------------------------------------------------------------------------------------------------------------------------------------------------
							
								txtbx_brand.Text = ERP_P1_objDR["DOT_PRODATTRIBBRAND"].ToString();
								txtbx_remark1.Text = ERP_P1_objDR["NOTESEXTERNAL"].ToString();
								txtbx_remark1.Text =  ERP_P1_objDR["NOTESINTERNAL"].ToString();
								txtbx_remark7.Text = ERP_P1_objDR["NOTESSHIPPINGLABEL"].ToString();
...
//=======================================================================================================================================================================================================================================================================================================		 
					...
					string SOStockCode2;
					string SOCustomerType;
					
					

					string ERP_P2_objSqlStatement = "select CUSTGROUP, ITEMID from VIEW_AXERP_SO_DETAIL where ITEMID = '" + SOCustomerCode + "'";
					SqlConnection ERP_P2_objConn = new SqlConnection(sqlconn3);
...
//====================================================================================================================================================================================================================================================================================
								{
									...
									SOStockCode2 = ERP_P2_objDR["ITEMID"].ToString();
									

									SOCustomerType = ERP_P2_objDR["CUSTGROUP"].ToString();
								
									
								
//								if(SOStockCode2.Substring(0,5) =="WJ820"  && SOCustomerType == "LC")
//								{
//									
...
//					//ERP_P2_objConnString = null;
	...
	//@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
					...
					string ERP_P3_objSqlStatement = "select * from VIEW_AXERP_SO_DETAIL where ITEMID = '" + SOCustomerCode + "'";
					...
					try {
						...
						if (ERP_P3_objDR.HasRows) 
						{
							...
							if (ERP_P3_objDR.Read())
							{
								TxtBx_JRColor1.Text = ERP_P3_objDR["DOT_PRODATTRIBCOLOR"].ToString().ToUpper();
							}
				...
				else if (string.IsNullOrWhiteSpace(txtbx_jrwidth.Text)) 
				 
				{
					txtbx_jrwidth.Text = "0";
				}
				
				else if (string.IsNullOrWhiteSpace(txtbx_jrlength.Text)) 
            ...
            double jojrqty = 0;
	             ...
	             if (txtbx_M2.Text == "M2" || txtbx_M2.Text == "KG" )
	             {
	             	//MessageBox.Show("m2");
...
//					if (txtbx_brand.Text.ToUpper() == "MZPK")
//					{
//						combobx_category.Text = "MZPK";
//					}
