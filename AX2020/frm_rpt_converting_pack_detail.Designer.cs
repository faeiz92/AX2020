...
namespace AX2020
{
	partial class frm_rpt_converting_pack_detail
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			this.lbl_header.Text = "PRODUCTION OUTPUT - PACKING DETAIL";
			...
			this.btn_cancel.Location = new System.Drawing.Point(432, 610);
			...
			// label2
			// 
			this.label2.Location = new System.Drawing.Point(443, 638);
			...
			// 
			// frm_rpt_converting_pack_detail
			// 
			...
			this.Name = "frm_rpt_converting_pack_detail";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "Production Output - Packing Detail";
