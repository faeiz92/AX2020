...
namespace AX2020
{
	partial class frm_rpt_converting_cutting_fast
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			this.lbl_header.Text = "PRODUCTION OUTPUT - CUTTING FAST INFO";
			...
			// 
			// frm_rpt_converting_cutting_fast
			// 
			...
			this.Name = "frm_rpt_converting_cutting_fast";
