...
namespace AX2020
{
	partial class frm_ax_stock_status_pm02
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			this.lbl_header.TabIndex = 165;
			this.lbl_header.Text = "PM02 GLUE PRODUCTION";
			...
			this.Name = "frm_ax_stock_status_pm02";
			this.Text = "frm_ax_stock_status_pm02";
