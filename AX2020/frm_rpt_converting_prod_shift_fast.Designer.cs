...
namespace AX2020
{
	partial class frm_rpt_converting_prod_shift_fast
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			this.lbl_header.Text = "PRODUCTION OUTPUT - SLITTING SHIFT FAST INFO";
			...
			// 
			// frm_rpt_converting_prod_shift_fast
			// 
			...
			this.Name = "frm_rpt_converting_prod_shift_fast";
