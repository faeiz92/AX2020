...
namespace AX2020
{
	partial class frm_prod_stretch_film_popup
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			this.Name = "frm_prod_stretch_film_popup";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterParent;
			this.Text = "Select ";
			this.Load += new System.EventHandler(this.Frm_prod_ribbon_popupLoad);
