...
namespace AX2020
{
	partial class frm_prod_warehouse_transfer_mov
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			this.lbl_header.Text = "AX JR MOVEMENT";
			...
			// 
			// frm_prod_warehouse_transfer_mov
			// 
			...
			this.Name = "frm_prod_warehouse_transfer_mov";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "AX JR Movement";
