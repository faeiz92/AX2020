...
namespace AX2020
{
	partial class frm_ax_stock_status_sm05
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			this.lbl_header.TabIndex = 194;
			this.lbl_header.Text = "SM05 FR";
			...
			this.Name = "frm_ax_stock_status_sm05";
			this.Text = "frm_ax_stock_status_sm05";
