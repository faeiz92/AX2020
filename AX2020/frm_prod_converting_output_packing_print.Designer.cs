...
namespace AX2020
{
	partial class frm_prod_converting_output_packing_print
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			this.lbl_header.Text = "REPRINT CONVERTING PACKING";
			...
			// 
			// frm_prod_converting_output_packing_print
			// 
			...
			this.Name = "frm_prod_converting_output_packing_print";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "Reprint Converting Packing";
