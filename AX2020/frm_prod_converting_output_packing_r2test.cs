...
namespace AX2020
{
	public partial class frm_prod_converting_output_packing_r2test : Form
	{
		...
		public frm_prod_converting_output_packing_r2test()
		{
			InitializeComponent();
...
//			}
			...
			if (LineNoGenerator() & sqlConnParm("SP_PROD_CONV_JO_PACKING_ADD_R2test"))
			{	
				//UpdateBal("SP_PROD_CONV_UPDATE_PACK_R2test");
		...
		void TotalRollCalculation()
		{
			try
			{
				...
				total = Double.Parse(txtbx_total_roll.Text);
			}
			catch(Exception e)
			{
				//LogFile(e);
