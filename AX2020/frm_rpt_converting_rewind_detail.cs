...
namespace AX2020
{
	...
	public partial class frm_rpt_converting_rewind_detail : Form
	{
		...
		public frm_rpt_converting_rewind_detail()
		{
		...
		private DataSet GetData(string date_fr, string date_to)
		{
			...
			{
				MessageBox.Show("Error - Converting Rewinding \nCannot load DB" + ex.Message + ex.ToString());
				return null;
			}
			finally
			{
