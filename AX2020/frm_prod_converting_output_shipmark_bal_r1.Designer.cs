...
namespace AX2020
{
	partial class frm_prod_converting_output_shipmark_bal_r1
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			this.lbl_header.Text = "PRINT CONVERTING SLITTING JR BALANCE";
			...
			// 
			// frm_prod_converting_output_shipmark_bal_r1
			// 
			...
			this.Name = "frm_prod_converting_output_shipmark_bal_r1";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "Print Converting Slitting JR Balance";
