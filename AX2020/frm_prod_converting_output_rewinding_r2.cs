...
namespace AX2020
{
	...
	public partial class frm_prod_converting_output_rewinding_r2 : Form
	{
		string init = "0";
		...
		public frm_prod_converting_output_rewinding_r2()
		{
			InitializeComponent();
...
//		
		...
		{
			txtbx_total_meter.Text = ((Int32.Parse(txtbx_no_logroll.Text) * Int32.Parse(txtbx_length_cust.Text)).ToString());
		}
