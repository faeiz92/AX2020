...
namespace AX2020
{
	partial class frm_prod_warehouse_transfer_bopp
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			this.lbl_header.Text = "AX BOPP TRANSFER";
			...
			this.txtbx_shipmark.KeyDown += new System.Windows.Forms.KeyEventHandler(this.Txtbx_shipmarkKeyDown);
			// 
			// groupbx_add
			// 
			...
			this.dt_grid_add.Size = new System.Drawing.Size(914, 335);
			...
			this.cbx_warehouse_to.Location = new System.Drawing.Point(638, 166);
			...
			// 
			// frm_prod_warehouse_transfer_bopp
			// 
			...
			this.Name = "frm_prod_warehouse_transfer_bopp";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "AX BOPP Transfer";
