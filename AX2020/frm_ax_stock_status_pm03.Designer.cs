...
namespace AX2020
{
	partial class frm_ax_stock_status_pm03
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			this.lbl_header.Location = new System.Drawing.Point(5, 20);
			...
			this.lbl_header.TabIndex = 168;
			this.lbl_header.Text = "PM03 RIBBON PRODUCTION";
			...
			this.Name = "frm_ax_stock_status_pm03";
			this.Text = "frm_ax_stock_status_pm03";
