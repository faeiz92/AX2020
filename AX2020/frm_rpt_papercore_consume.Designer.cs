...
namespace AX2020
{
	partial class frm_rpt_papercore_consume
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			this.lbl_header.Text = "PAPERCORE CONSUME";
			...
			this.Name = "frm_rpt_papercore_consume";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "Papercore Consume";
