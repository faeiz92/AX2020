...
namespace AX2020
{
	public partial class frm_prod_coating_jo_wip : Form
	{
		...
		string refno;
		string username, SDate;
		string twoWords;
		int NextNo2;
		
		//string storestockcode = txtbx_stockcode;
		//string storenextno = txtbx_nextno;

		
		public frm_prod_coating_jo_wip()	//function y terdapat dalam form
		{
			//
...
//						cmd_data_add.Parameters["@SP_JOSALESNO"].Value = txtbx_joso.Text.ToUpper();							;
						...
						cmd_data_add.Parameters["@SP_JOUSEREMAIL"].Value = "0";
    					

						
						cmd_data_add.Parameters.Add(new SqlParameter("@SP_JOUSERPC", SqlDbType.NVarChar, 50));
						cmd_data_add.Parameters["@SP_JOUSERPC"].Value ="0";
        ...
        rdlView.SourceFile = new Uri(baseUri,@"../report/planning_jo_coating_R4.3latest.rdl");
		...
		void Btn_deleteClick(object sender, EventArgs e)
		{
			...
			try {
					...
					cmd_data_del.CommandType = CommandType.StoredProcedure;
						...
						cmd_data_del.Parameters["@SP_JOUSEREMAIL"].Value = "0";
    					

						
						cmd_data_del.Parameters.Add(new SqlParameter("@SP_JOUSERPC", SqlDbType.NVarChar, 50));
						cmd_data_del.Parameters["@SP_JOUSERPC"].Value = "0";
    	
						cmd_data_del.Parameters.Add(new SqlParameter("@SP_JOUSERDATETIME", SqlDbType.DateTime));
						cmd_data_del.Parameters["@SP_JOUSERDATETIME"].Value =dateTimePicker1.Value; //"2016-11-28";//dateTimePicker1.Value.Date;
...
//               else if (CommonValidation.ValidateIsEmptyString(txtbx_joso.Text.Trim()))
//	                {
...
//			if (txtbx_joso.Text == "LOCAL" || txtbx_joso == "JR WIP")
//			{
//				
//			}
...
//--------------------------------------------------------------------------------------------			
		...
		void Btn_calcWeightClick(object sender, EventArgs e)
		{
			...
			txtbx_wtfilm.Text = Convert.ToString(Math.Round(((Convert.ToDouble(txtbx_bopp_micron.Text) * 0.91 * (double) Convert.ToDouble(txtbx_jrwidth.Text) / 1000 *  Convert.ToDouble(txtbx_jrlength.Text) / 1000)),2));
			...
			//double totalglue2;
			if (txtbx_gluecode.Text == "820SNY" || txtbx_gluecode.Text == "820S" || txtbx_gluecode.Text == "826" || txtbx_gluecode.Text == "8208" || txtbx_gluecode.Text == "824" )
			{
				totalglue = Math.Round(Convert.ToDouble(Double.Parse(txtbx_wtglue.Text) / 0.57 * Double.Parse(txtbx_jojrqty.Text)),2);
			}
			
			else if (txtbx_gluecode.Text == "8209" || txtbx_gluecode.Text == "SBT" || txtbx_gluecode.Text == "846" || txtbx_gluecode.Text == "8209 LV")
			{
