...
namespace AX2020
{
	...
	public partial class frm_rpt_coating_output_overweight : Form
	{
		...
		public frm_rpt_coating_output_overweight()
		{
			InitializeComponent();
		...
		private DataSet GetData(DateTime date_fr, DateTime date_to)
		{
			...
			SqlCommand cmd = new SqlCommand(@"SELECT * FROM VIEW_AX2020_ERP_COATING_OUTPUT_OVERWEIGHT WHERE TRXDATE BETWEEN @from_date AND @to_date", conn);
